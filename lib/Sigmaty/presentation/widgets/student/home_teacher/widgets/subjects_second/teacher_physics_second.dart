...
class TeacherPhysicsSecond extends StatelessWidget {
  const TeacherPhysicsSecond({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: (){},
      child: const CustomizeSubjectSecond(imageUrl: AssetsData.physics, txtSubject: 'فيزياء', txtNumberOfTeacher: '',),
    );
  }
}
