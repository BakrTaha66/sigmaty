...
class TeacherAutismSecond extends StatelessWidget {
  const TeacherAutismSecond({
    super.key,
  });
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
        onTap: (){},
        child: const CustomizeSubjectSecond(imageUrl: AssetsData.geography, txtSubject: 'جغرافيا', txtNumberOfTeacher: '',));
  }
}
