...
class CustomizeTeacherImageSec extends StatelessWidget {
  const CustomizeTeacherImageSec({super.key, required this.imageUrl, required this.subjectName, required this.teacherName, required this.yearOfSecondary, required this.onTap,});
